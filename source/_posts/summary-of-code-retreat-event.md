...
（在编程的最佳实践方面也有了不少收获，主要有具体如何通过多态减少代码分支结构、无副作用方法（immutable）每次都能返回一个新的对象，而不是修改以前的对象，但这也只是观察到的，由于这次并没有实际参与编程，这些最佳实践还并没有亲自操练，在接下来这周内，要亲自找pair亲自操练一下Game of Life）